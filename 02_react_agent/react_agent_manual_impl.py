...
if __name__ == '__main__':
    ...
    llm = ChatOpenAI(temperature=0, model="gpt-4o-mini", stop_sequences=["\nObservation", "Observation"], callbacks=[AgentCallbackHandler()])
    ...
    while not isinstance(agent_step, AgentFinish):
        agent_step: Union[AgentAction, AgentFinish] = agent.invoke({"input": "What is the length in characters of the text CAT?", "agent_scratchpad": intermediate_steps})
        print(agent_step)
